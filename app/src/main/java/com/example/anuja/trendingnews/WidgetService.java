...
import com.example.anuja.trendingnews.utilities.SharedPreferenceUtils;
...
public class WidgetService extends IntentService {
    private static final String ACTION_UPDATE_WIDGETS = "com.example.anuja.trendingnews.action.update.widgets";
    private static final String ACTION_UPDATE_NEWS = "com.example.anuja.trendingnews.action.update.news";
    private static final String EXTRA_NEWS = "com.example.anuja.trendingnews.extra.news";
